...
using ProductManager.Web.Models.Account;
using ProductManager.Web.Views.Shared.Components.TenantChange;
...
public class AccountController : ProductManagerControllerBase
{
