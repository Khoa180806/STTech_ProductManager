...
namespace ProductManager.EntityFrameworkCore.Seed.Host;
...
public class DefaultLanguagesCreator
{
    ...
    {
        var tenantId = ProductManagerConsts.MultiTenancyEnabled ? null : (int?)MultiTenancyConsts.DefaultTenantId;
